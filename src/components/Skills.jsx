    ...
    <section id="skill">
      ...
      <div className="cards">
        <div className="card red">
          <p>
            <button className="skilss">{t('skills_backend')}</button>
          </p>
          <div className="PhoneTitle">{t('skills_backend')}</div>
        ...
        <div className="card blue">
          <p>
            <button className="skilss">{t('skills_frontend')}</button>
          </p>
          <div className="PhoneTitle">{t('skills_frontend')}</div>
